...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (firstInstance)
        {
            ...
            GetComponent<LevelGenerator>().Create();
            User.Init();
            DatabaseManager.Connect();
            CheckPreferencesFile();
            LevelController.EnableGyro();
        }
        gyroButton = GameObject.FindGameObjectWithTag("Gyro");
    }
    ...
    public void PressGyroButton()
    {
        ResetGyro();
        StartCoroutine("ActivateGyroButton");
    }

    IEnumerator ActivateGyroButton()
    {
    ...
    {
        LevelController.ResetReferenceRotation();
    }
